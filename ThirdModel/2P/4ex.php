...
$userId = $db->addUser("Oleg", "oleg@example.com", "password123");
if ($userId) {
    echo "Пользователь добавлен с ID: $userId\n";
}

$user = $db->getUserByEmail("oleg@example.com");
print_r($user);

$injectionAttempt = $db->getUserByEmail("oleg@example.com' OR '1'='1");
if ($injectionAttempt === false) {
    echo "\nПопытка SQL-инъекции предотвращена!";
}
