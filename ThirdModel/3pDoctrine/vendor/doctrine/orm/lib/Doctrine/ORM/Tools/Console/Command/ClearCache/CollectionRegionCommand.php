...
<info>%command.name% 'Entity\MyEntity' 'collectionName'</info>

To invalidate a specific entry you should use :

<info>%command.name% 'Entity\MyEntity' 'collectionName' 1</info>
...
<info>%command.name% 'Entity\MyEntity' 'collectionName' --flush</info>
