...
class Loader
{
    ...
    /**
     * Determines if we must order DataFixtures by number
     */
    private bool $orderFixturesByNumber = false;

    /**
     * Determines if we must order DataFixtures by its dependencies
     */
    ...
    /**
     * Find DataFixtures classes in a given directory and load them.
     *
     * @param string $dir Directory to find fixture classes in.
     *
     * @return array $DataFixtures Array of loaded fixture object instances.
     */
    ...
    /**
     * Find DataFixtures classes in a given file and load them.
     *
    ...
    /**
     * Returns the array of data DataFixtures to execute.
     *
    ...
    /**
     * Check if a given fixture is transient and should not be considered a data DataFixtures
     * class.
     *
    ...
    /**
     * Orders DataFixtures by dependencies
     */
    private function orderFixturesByDependencies(): void
    {
        ...
        // If DataFixtures were already ordered by number then we need
        // to remove classes which are not instances of OrderedFixtureInterface
        // in case DataFixtures implementing DependentFixtureInterface exist.
        // This is because, in that case, the method orderFixturesByDependencies
        // will handle all DataFixtures which are not instances of
        // OrderedFixtureInterface
        if ($this->orderFixturesByNumber) {
        ...
        // Now we order DataFixtures by sequence
        $sequence  = 1;
        $lastCount = -1;
        ...
        // If there're DataFixtures unsequenced left and they couldn't be sequenced,
    ...
    /**
     * Load DataFixtures from files contained in iterator.
     *
     * @phpstan-param Iterator<SplFileInfo> $iterator Iterator over files from
     *                                              which DataFixtures should be loaded.
     *
     * @phpstan-return list<FixtureInterface> $DataFixtures Array of loaded fixture object instances.
     */
