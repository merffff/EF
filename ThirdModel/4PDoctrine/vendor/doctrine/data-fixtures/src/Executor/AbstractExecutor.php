...
abstract class AbstractExecutor implements LoggerAwareInterface
{
    ...
    /**
     * Purger instance for purging database before loading data DataFixtures
     */
    ...
    public function load(ObjectManager $manager, FixtureInterface $fixture): void
    {
        ...
        // additionally pass the instance of reference repository to shared DataFixtures
        ...
        if ($this->purger === null) {
            throw new Exception(
                PurgerInterface::class .
                 ' instance is required if you want to purge the database before loading your data DataFixtures.',
            );
        }
    ...
    /**
     * Executes the given array of data DataFixtures.
     *
     * @param FixtureInterface[] $fixtures Array of DataFixtures to execute.
     * @param bool               $append   Whether to append the data DataFixtures or purge the database before loading.
     */
